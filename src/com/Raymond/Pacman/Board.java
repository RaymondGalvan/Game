...
public class Board extends JPanel implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7512878693508221753L;
    ...
    private int pacmanx1, pacmany1, pacmandx1, pacmandy1;
    ...
    private void doAnim1() {
    	...
    	if(pacanimcount <= 0) {
			...
			if (ghostx[i] % blocksize == 0 && ghosty[i] % blocksize == 0)
			{    		
				int pos = ghostx[i] / blocksize + nrofblocks * (int) (ghosty[i] / blocksize);
